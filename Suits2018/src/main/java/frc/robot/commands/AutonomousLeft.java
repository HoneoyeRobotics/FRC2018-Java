...
public class AutonomousLeft extends CommandGroup {
	public AutonomousLeft() {
        ...
        if(TeamSwitchLeft == true) {
    		...
    		addSequential(new RotateDegrees(45, Direction.LEFT, 3, RobotMap.ROTATE_DEGREES_DEADBAND));
    		//drive forward 16 inches, timeout at 2 seconds
    		addSequential(new DriveForDistance(RobotMap.DRIVE_DISTANCE_SPEED, 16, 2));
    		//rotate back to 0
    		addSequential(new RotateToDegrees(0, Direction.RIGHT, 3, RobotMap.ROTATE_DEGREES_DEADBAND));
