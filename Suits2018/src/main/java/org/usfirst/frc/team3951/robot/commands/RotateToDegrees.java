...
public class RotateToDegrees extends  Command {
	...
	protected void execute() {
		...
		double speed = degreesRemaining / RobotMap.GYRO_ROTATE_SLOW_FACTOR;

		//if the speed is outside of the max/min speed, change it.
		if(speed > RobotMap.GYRO_ROTATE_MAX_SPEED)
			speed = RobotMap.GYRO_ROTATE_MAX_SPEED;
		else if (speed < RobotMap.GYRO_ROTATE_MIN_SPEED)
			speed = RobotMap.GYRO_ROTATE_MIN_SPEED;
